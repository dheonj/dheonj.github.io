...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.40bbbee56aa84a4d66eaf08ccf4c2055f019930c70f180eef20d6cdde32d5f87.js',function(){input.required=false;search();});}
